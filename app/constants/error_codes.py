...
class SuccessMessage:
    ...
    KOUJYOU_MASTER_CREATED = "工場マスタを作成しました"
    KOUJYOU_MASTER_BATCH_CREATED = "工場マスタを一括作成しました"
    KOUJYOU_MASTER_UPDATED = "工場マスタを更新しました"
    KOUJYOU_MASTER_BATCH_UPDATED = "工場マスタを一括更新しました"
    KOUJYOU_MASTER_BATCH_DELETED = "工場マスタを一括削除しました"
    # CUSTOM_MASTER_RETRIEVED = "得意先マスタを取得しました"
    # CUSTOM_MASTER_LIST_RETRIEVED = "得意先マスタの取得が完了しました"
    # CUSTOM_MASTER_UPDATED = "得意先マスタを更新しました"
    # CUSTOM_MASTER_DELETED = "得意先マスタを削除しました"
